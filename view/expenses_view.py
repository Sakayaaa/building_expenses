...
class ExpensesView:
    ...
    def __init__(self):
        ...
        self._id = LabelAndEntry(self.win, "Id", 20, 20, data_type="int", state="readonly")
        self._month = LabelAndEntry(self.win, "Month:", 23, 70)
        self._water = LabelAndEntry(self.win, "water:", 23, 120)
        self._electricity = LabelAndEntry(self.win, "electricity:", 23, 170)
        self._gas = LabelAndEntry(self.win, "gas:", 23, 220)
        self._elevator = LabelAndEntry(self.win, "elevator:", 23, 270)
        self._cleaning = LabelAndEntry(self.win, "cleaning:", 23, 320)
        self._engine_room = LabelAndEntry(self.win, "engine room:", 23, 370)
        self._other = LabelAndEntry(self.win, "other:", 23, 420)
        ...
        TkButton(self.win,"Refresh",self.reset_form,400,390,130,50)
        TkButton(self.win,"Save",self.save_click,550,390,130,50)
        TkButton(self.win,"Edit",self.edit_click,700,390,130,50)
        TkButton(self.win,"Remove",self.remove_click,850,390,130,50)
