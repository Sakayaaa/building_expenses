...
class UnitsInfoView:
    ...
    def __init__(self):
        ...
        self.id = LabelAndEntry(self.win, "Id", 20, 20, distance=90, state="readonly")
        self.unit_no = LabelAndEntry(self.win, "Unit No.", 310, 20, distance=90)
        self.first_name = LabelAndEntry(self.win, "First Name", 20, 60, distance=90)
        self.family_name = LabelAndEntry(self.win, "Family Name", 310, 60, distance=90)
        self.resident_count = LabelAndEntry(self.win, "Resident Count", 20, 100, distance=90)
        ...
        TkButton(self.win, "Save", self.save_click, 60, 445)
        TkButton(self.win, "Edit", self.edit_click, 170, 445)
        TkButton(self.win, "Remove", self.remove_click, 280, 445)
        TkButton(self.win, "Refresh", self.reset_form, 390, 445)
